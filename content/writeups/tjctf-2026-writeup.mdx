...
summary: Crypto solves from THJCC 2026.
...
![THJCC Logo](/ctf-writeups/tjctf-2026/tjctf-2026.png)

## CTF Event Info
| CTF Organizer                                                     | CTF Team | CTFTime URL                                              | CTF Platform |
|-------------|-----------------------------------------------------|----------|------------------------------------------------------------------------------------------------------|
| [Thomas Jefferson High School for Science and Technology in Northern Virginia](https://tjctf.org/) | [KSAL Cyber Team](https://ctftime.org/team/424982) | [ctftime.org/event/3088](https://ctftime.org/event/3088) | [https://ctf.tjctf.org/](https://ctf.tjctf.org/) |
