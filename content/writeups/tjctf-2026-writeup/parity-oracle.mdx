---
title: Parity Oracle
summary: Recovering an RSA plaintext with an LSB oracle.
tags: Cybersecurity, CTF, Writeup, Crypto
publishedAt: '2026-05-16'
public: true
language: "en"
translationKey: "tjctf-2026-parity-oracle"
---
...
- If `2m < n`: no wrap, result is even, LSB = 0, and `m` is in `[0, n/2)`.
- If `2m >= n`: wraps once, result is odd, LSB = 1, and `m` is in `[n/2, n)`.
