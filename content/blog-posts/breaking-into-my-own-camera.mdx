...
tags: IoT Security, Vulnerability Research, CVE, Network Security, Reverse Engineering, API Security
summary: "Six assigned CVEs in a Fullhan-based IP camera cover unauthenticated API access, credential disclosure, command injection, and full device compromise."
...
MITRE assigned six CVE IDs to the findings in this research. The CVSS v3.1 scores below are my assessments based on an attacker reaching the camera from the adjacent local network; the CVE records were reserved at the time of this update.

| CVE ID | Finding | CVSS v3.1 |
| --- | --- | --- |
| **CVE-2026-51402** | Unauthenticated blind OS command injection through the custom `<SYSTEM>` protocol on TCP port 1300 | **8.8** (`CVSS:3.1/AV:A/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H`) |
| **CVE-2026-51403** | Unauthenticated read/write access to PSIA API endpoints | **8.8** (`CVSS:3.1/AV:A/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H`) |
| **CVE-2026-51404** | Unauthenticated live snapshots through `/snapshot.jpg` on TCP port 6688 | **6.5** (`CVSS:3.1/AV:A/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N`) |
| **CVE-2026-51405** | BusyBox Telnet enabled by default, exposing an interactive root shell when chained with the credential or command-injection findings | **8.8** (`CVSS:3.1/AV:A/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H`) |
| **CVE-2026-51406** | Unauthenticated plaintext credential disclosure through `/PSIA/Security/AAA/users` | **6.5** (`CVSS:3.1/AV:A/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N`) |
| **CVE-2026-51407** | Plaintext Wi-Fi credentials stored in `/app/userdata/ifcfg.wlan0` | **7.4** (`CVSS:3.1/AV:A/AC:L/PR:N/UI:N/S:C/C:H/I:N/A:N`) |
...
- Blind command execution via the custom protocol on port 1300 (**CVE-2026-51402**)
- No access control on PSIA API read/write operations (**CVE-2026-51403**)
- Exposed camera feed via `snapshot.jpg` (**CVE-2026-51404**)
- Telnet enabled by default (**CVE-2026-51405**)
- Plaintext credential exposure through `/PSIA/Security/AAA/users` (**CVE-2026-51406**)
- Sensitive Wi-Fi credentials stored in plaintext (**CVE-2026-51407**)
