...
broken access control, stored XSS, RCE, SQL injection, and SSTI."
---

![Chamaleon Breached](/blog-posts/camaleon-cms-rce/camaleon-cms-logo.png)
...
Me and my cousin are in a small CTF team called [KSAL Cyber Team](https://github.com/KSAL-Cyber-Team), a group of like-minded cybersecurity enthusiasts. We had just finished [THJCC CTF 2026](https://ctftime.org/event/3088)
...
Our curiousity turned into full security review and six documented vulnerabilites (please keep reading).

We started documenting our findings and tried to report it responsibly. That part, unfortunately, didn't go that well.

Huge thanks to the members of our country's official DEFCON chapter, [DEFCON GROUP PRISHTINA (DC38338)](http://dc38338.org/) for helping us confirm the vulnerabilites early on.

## Disclosure Timeline
This is maybe out of line, but I have to be honest about how it went, because it matters.

On February 19, 2026 (19/02/2026), the same day we found everything, we sent a disclosure email to the vendor. We included all the researchers mentioned in their [SECURITY.MD](https://github.com/owen2345/camaleon-cms/security), laid out some of the vulnerabilities clearly, and told them to contact us for more details.
...
<ins>However, we never heard back</ins>.
...
<ins>Also ignored</ins>.

At some point after that, fixes started quietly appearing in the repository. Whether they read our report, ran a SAST tool, or they were just found, we have no idea, they never told us. No coordination, no confirmation of what was actually fixed, no contact at any point.
...
# Conclusion
Six vulnerabilities under my belt from what was supposed to be a casual session. Honestly wouldn't trade it for anything in the world.
...
Timing wise, waiting 40+ days without a response, then fixes showing up in commmits with no communication, that leaves you in a very tough and vulnerable position. Going forward, I'll mention the deadline upfront (the way Google has it) in the initial email, making it clear that public disclosure on a specific date.

<ins>It's a standard practice for a reason.</ins>
...
NGUgNWYgNjEgNzYgNzAgNzIgNWYgNzIgNmUgNjYgNjcgNzIgNjUgNWYgNzIgNzQgNzQgNWYgNzMgNjIgNjUgNWYgNzUgNmUgNzAgNzggNzIgNjUgNjY=