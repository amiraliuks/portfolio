    ...
    <>
      ...
      >
        ...
        <img
          ...
          decoding="async"
          className={cn("h-auto w-full rounded-none border border-border/60", className)}
          style={{ backgroundColor: "white", ...props.style }}
        />
        <span className="pointer-events-none absolute right-3 top-3 inline-flex border border-border bg-background/85 p-2 text-foreground opacity-0 shadow-sm backdrop-blur transition group-hover:opacity-100 group-focus-visible:opacity-100">
